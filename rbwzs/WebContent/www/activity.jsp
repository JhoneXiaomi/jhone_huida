	...
	<div class="ej_main">
	  ...
	  <div class="ej_weizhi">
	     <div class="w1200 clearfix">
	       ...
	       <div class="ej_local_right fr">您的当前位置：<a href="${ctx }/">首页</a>&nbsp;>>&nbsp;<a href="javascript:void(0)">热门活动</a></div>
	     </div> 
	  </div>
	      ...
	      <c:forEach items="${newsList }" var="news">
			...
			<dl class="clearfix">
		      ...
		      <dd class="ej_huodong_info fr">
		         <h4>
			         <a href="${ctx}/activityDetail?newsId=${news.newsId}&type=${news.type }">
			         		<c:choose>
		         ...
		         <div class="huodong_more">
		         		<a href="${ctx}/activityDetail?newsId=${news.newsId}&type=${news.type }">活动详情...</a>
		         </div>
		      </dd>
		    </dl>	      
	      </c:forEach>
	  ...
	  <div class="Page clearfix">
		 <ul>
			 ...
			 <li class="paging_page">
	         	<a <c:if test='${page.pageNo == i }'>style="width: 36;height: 32;background-color:#009c42;color:#FFF;"</c:if> href="${pageContext.request.contextPath}/activity/p${i }">&nbsp;${i}&nbsp;</a>
	         </li>	
			 </c:forEach>			         					
