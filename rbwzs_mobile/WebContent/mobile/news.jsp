...
<div class="wrap">
 <div class="ej_top">
  <div class="ej_tit clearfix">
   ...
   <div class="lanmu">装修新闻</div>
  </div>
 <div class="ej_local fl">您的当前位置：<a href="${ctx }/">首页</a>> <a href="javascript:void(0)">装修新闻</a></div>
 </div>
 <div class="clear"></div>
 <div class="news_list clearfix">
 <c:forEach items="${newsList }" var="news">
	    <dl class="clearfix">
	    <a href="${ctx }/m/newsDetail?newsId=${news.newsId}" class="clearfix">
	      <dt><img src="${news.thumbImg }"/></dt>
	      <dd>
	        <h4>
	         <c:choose>
	        	<c:when test="${fn:length(news.title)>17 }">${fn:substring(news.title,0,17) }</c:when>
