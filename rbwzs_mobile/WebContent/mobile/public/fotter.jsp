...
<div class="mFooter">
  <ul>
    <li ><a href="${ctx }/" ><img src="${ctx }/mobile/images/1.png" ><p>网站首页</p></a></li>
    <li><a href="${ctx }/m/order"><img src="${ctx }/mobile/images/2.png" ><p>申请报价</p></a></li>
    <li>
    
    <c:if test="${branchCompany == 'sjzrbw1'}">
    
    	<a href="http://p.qiao.baidu.com/cps/chat?siteId=10017115&userId=6095603"><img src="${ctx }/mobile/images/3.png" ><p>在线咨询</p></a>
    </c:if>
    ...
    <c:if test="${branchCompany == 'bdrbw1'}">
   	    ...
   	    <a href="http://p.qiao.baidu.com/cps/chat?siteId=10016909&userId=6095603"><img src="${ctx }/mobile/images/3.png" ><p>在线咨询</p></a>
    </c:if>
    
      
    <c:if test="${branchCompany == 'lfrbw1'}">
    
    	<a href="http://p.qiao.baidu.com/cps/chat?siteId=10017826&userId=6095603"><img src="${ctx }/mobile/images/3.png" ><p>在线咨询</p></a>
    </c:if>	
    
    </li>
    <li><a href="tel:${sessionScope.MhomeTp.value }"><img src="${ctx }/mobile/images/4.png" ><p>电话预约</p></a></li>
  </ul>
</div>
<style>
