...
public class Cases implements Serializable {
	...
	public void setDesignerPhotoImg(String designerPhotoImg) {
		this.designerPhotoImg = designerPhotoImg;
	}

	public String getCaseLogoImg() {
		return caseLogoImg;
	}

	public void setCaseLogoImg(String caseLogoImg) {
		this.caseLogoImg = caseLogoImg;
	}
	...
	public void setDesignerTitle(String designerTitle) {
		this.designerTitle = designerTitle;
	}
