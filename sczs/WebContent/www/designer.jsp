  ...
  <div class="list_main w1180">
    ...
    <div class="list_al clearfix">
       ...
       <c:forEach items="${designerList }" var="designer" varStatus="status">
	      		 ...
	      		 <dl>
			        ...
			        <dd>
			          <div class="list_info">
			            <span><b style="color:#f39800">${designer.designerName }</b>&nbsp;&nbsp;设计师</span>
			            <span>从业时间:&nbsp;&nbsp;${designer.designerWorkTime} &nbsp;&nbsp;
			            <div class="list_p_yy">
			            	<a href="${pageContext.request.contextPath}/designerMessage/p1?designerId=${designer.designerId}">预约</a>
			            </div>
			            </span>
			          </div>
			        </dd>
    ...
    <div class="list_per_lc">
      ...
      <div class="Tech w1180">
        <a href="${pageContext.request.contextPath}/orderLine"><div class="tech_con"><img src="${pageContext.request.contextPath}/www/images/tech01.jpg"><span>在线预约</span><img src="${pageContext.request.contextPath}/www/images/jiantou01.jpg"></div></a>  
        <div class="tech_con"><img src="${pageContext.request.contextPath}/www/images/tech02.jpg"><span>上门量房</span><img src="${pageContext.request.contextPath}/www/images/jiantou01.jpg"></div>
        <div class="tech_con"><img src="${pageContext.request.contextPath}/www/images/tech03.jpg"><span>方案设计</span><img src="${pageContext.request.contextPath}/www/images/jiantou01.jpg"></div>
        <div class="tech_con"><img src="${pageContext.request.contextPath}/www/images/tech04.jpg"><span>施工装修</span><img src="${pageContext.request.contextPath}/www/images/jiantou01.jpg"></div>
        <div class="tech_con"><img src="${pageContext.request.contextPath}/www/images/tech05.jpg"><span>验收竣工</span><img src="${pageContext.request.contextPath}/www/images/jiantou01.jpg"></div>
