...
<div class="wrap">
  <!-- 代码 开始 -->
   <div class="mMain"> 
    ...
    <div class="clear"></div>
  <div class="mTaocan">
    <img src="${ctx }/mobile/images/bdtaocan_01.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_02.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_03.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_05.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_06.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_07.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_08.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_09.jpg"/>
    <img src="${ctx }/mobile/images/bdtaocan_10.jpg"/>
