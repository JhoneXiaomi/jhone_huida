...
<div class="wrap">
  <!-- 代码 开始 -->
   ...
   <div class="mMain"> 
    ...
    <div class="mList_al clearfix">
      ...
      <div class="mList_position fr">您的当前位置：<a href="${ctx }/">首页</a> > <a href="${ctx }/Mspec">装修知识</a></div>
    </div>
  ...
  <div class="mCont_news_con">${news.contents }</div>
    ...
    <div class="mCont_news">
      <h4>推荐活动<p class="fr"><a href="">更多活动 >></a></p></h4>
      <ul>
      	<c:forEach items="${newListNews }" var="news" begin="0" end="7">
      	
      		  <li><span><fmt:formatDate value="${news.updateTime }" pattern="yyyy-MM-dd HH:mm:ss"/></span><a href="${ctx }/newDetail?newsId=${news.newsId}">${news.title }</a></li>
      	</c:forEach>
