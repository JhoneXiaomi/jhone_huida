  ...
  <div class="sc_txxw_form">
  	<form>
       <select id="branchCompany" name="branchCompany" class="city">
         ...
         <option value="sjzsc" selected="selected">石家庄</option>
  ...
  function submitXinXi(){
		 ...
		 if(!reg.test(acreages)){
			...
			$.ajax({
					...
					data : {'branchCompany':branchCompany,'orderId':orderId,'clientName':clientName,'phone':phone,'sourceType':'腾讯新闻石家庄报价'+source,'acreage':acreage},
...
<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1261872656'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s11.cnzz.com/z_stat.php%3Fid%3D1261872656%26show%3Dpic1' type='text/javascript'%3E%3C/script%3E"));</script>
</div>
</html>