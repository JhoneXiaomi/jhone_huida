...
public class HotBuilding implements Serializable {
	...
	public void setHouseDesigner(String houseDesigner) {
	...
	public String getDsesignerId() {
		return dsesignerId;
	}

	public void setDsesignerId(String dsesignerId) {
		this.dsesignerId = dsesignerId;
	}
