...
<script type="text/javascript" src="${ctx }/www/about/js/jquery-1.7.2.min.js"></script>
<script src="${ctx }/www/about/js/jquery.superslide.2.1.1.js" type="text/javascript"></script>
...
<body>
				...
				<div class="b">
					...
					<ul class="u-listB clearfix">
						...
						<li>
							<div class="inner">
								<div class="u-img1">
									<a href=""><img src="images/shejishi_02.jpg" /></a>
								</div>
								<div class="u-txt5">
									<a href="">王园</a>
								</div>
						...
						<li>
							<div class="inner">
								<div class="u-img1">
									<a href=""><img src="images/shejishi_03.jpg" /></a>
								</div>
								<div class="u-txt5">
									<a href="">张建新</a>
								</div>
						...
						<li>
							<div class="inner">
								<div class="u-img1">
									<a href=""><img src="images/shejishi_04.jpg" /></a>
								</div>
								<div class="u-txt5">
									<a href="">李忠良</a>
								</div>
						...
						<li>
							<div class="inner">
								<div class="u-img1">
									<a href=""><img src="images/shejishi_05.jpg" /></a>
								</div>
								<div class="u-txt5">
									<a href="">赵利明</a>
								</div>
						...
						<li>
							<div class="inner">
								<div class="u-img1">
									<a href=""><img src="images/shejishi_01.jpg" /></a>
								</div>
								<div class="u-txt5">
									<a href="">赵利明</a>
								</div>
	...
	<div class="pinpai_inp">
		...
		<div class="pinpai_input">
			<form>
				<input type="text" placeholder="请输入您的姓名" /> <input type="text"
					name="pinpai_phone" placeholder="请输入您的手机号码" class="" /> <input
					type="submit" class="pinpai_sub" />
			</form>
		</div>
	</div>
