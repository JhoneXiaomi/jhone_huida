...
public class SendEmailUtil {
    ...
    public static void main(String[] args) {
        ...
        int port = 25;
        String from = "1060547337@qq.com";
        String toEmail = "544402091@qq.com";
        String username = "张志伟";
        String password = "zzw1060547337";
       /* String host = "smtp.huidajt.com";
        int port = 25;
        String from = "sys@huidajt.com";
        String toEmail = "544402091@qq.com";
        String username = "sandisk_pkgwarp@126.com";
        String password = "yAwf3aX6BATqBiKh";*/
