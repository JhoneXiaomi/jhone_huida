...
<body>
	<div class="neiye-top">装修攻略<div class="neiye-fanhui"><a href="javascript:void" onclick="javascript:history.go(-1)">返回</a></div></div>
	<div class="weizhi"><em class="dqwz">当前位置</em><a href="${ctx }/">首页</a>&gt;<a href="javascript:void(0)">装修攻略</a></div>
	<div class="nycase">
		<ul class="nycaselb">
	...
	<div class="pages">
		<ul>
	     <c:if test="${page.pageNo > 1}" >
				<li class="paging_next"><a href="${pageContext.request.contextPath}/MdecStrategy/p${page.pageNo-1 }">上一页</a></li>
	         </c:if>
	         <c:if test="${page.pageNo <= 1}" >
	         ...
	         <c:forEach var="i" begin="1" end="${page.pageCount}">
	          <li class="paging_current">
	         	 <a <c:if test='${page.pageNo == i }'>style="background-color:#f39800;color:#FFF;"</c:if> href="${pageContext.request.contextPath}/MdecStrategy/p${i }">&nbsp;${i}&nbsp;</a>
	          </li>
			 </c:forEach>
			 <c:if test="${page.pageNo < page.pageCount}" >
			   <li class="paging_next"><a href="${pageContext.request.contextPath}/MdecStrategy/p${page.pageNo+1 }">下一页</a></li>
