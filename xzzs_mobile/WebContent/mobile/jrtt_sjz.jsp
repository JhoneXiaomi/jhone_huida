...
<div class="population">
  ...
  <div class="sjzxz19zn">
    <img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_01.jpg" /> 
    <img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_02.jpg" /> 
    <a onclick="baoMing()"><img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_03.jpg" /></a>
    <img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_04.jpg" />
    <img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_05.jpg" />
    <img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_06.jpg" />
  </div>
  
  <div class="sjzxz19zn_txt">
    <h3>今天已有<font>503</font>位业主报名了活动</h3>
    ...
    <form>
       <select id="branchCompany" name="branchCompany" class="city">
         ...
         <option value="sjzxz"  selected="selected">石家庄</option>
       ...
       <div class="tel">
          <a href="tel:13466399750" style="margin-right:3%;margin-left:3%; width:45%; float:left;"><img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_08.jpg" width="100%"></a>
          <a onclick="submitXinXi()" style=" width:45%; float:left;"><img src="${ctx }/mobile/images/sjzxz19zn/sjzxz_19zn_07.jpg" width="100%"></a>
       </div>
        <div class="wyfooter" style="margin-top: 3px ;height: 35px; line-height:35px;font-size: 13px; text-align:center;background:#f2f2f2;">
        	Copyright @2015-2016 京ICP备12044014号   <br /> 北京新洲伟业装饰有限公司 
        </div>
    </form>
  </div>
...
function submitXinXi(){
	...
	if(submitNumber!=0){
		...
		$.ajax({
				...
				data : {'branchCompany':branchCompany,'orderId':orderId,'clientName':clientName,'phone':phone,'sourceType':'今日头条石家庄'+source},
