...
public class Cases implements Serializable {
    ...
    private Integer caseThumbNumber;
    
    private static final long serialVersionUID = 1L;
    
    public Integer getCaseThumbNumber() {
		return caseThumbNumber;
	}

	public void setCaseThumbNumber(Integer caseThumbNumber) {
		this.caseThumbNumber = caseThumbNumber;
	}
