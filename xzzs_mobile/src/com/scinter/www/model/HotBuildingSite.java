...
public class HotBuildingSite implements Serializable {
    ...
    private Integer fimages;
    
    private Integer ximages;
    
    private static final long serialVersionUID = 1L;

    
    public Integer getFimages() {
		return fimages;
	}

	public void setFimages(Integer fimages) {
		this.fimages = fimages;
	}

	public Integer getXimages() {
		return ximages;
	}

	public void setXimages(Integer ximages) {
